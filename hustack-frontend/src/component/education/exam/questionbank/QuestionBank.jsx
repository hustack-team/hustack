    ...
    history.push({
      ...
      state: {
        question: {
          ...
          answers: rowData.type === 0 ? rowData.answers : [],
          contentAnswers: rowData.type === 0 ? rowData.answers.map(answer => answer.content) : [],
          contentFileAnswers: rowData.type === 0 ? rowData.answers.map(answer => answer.file) : [],
