...
export default function UploadUserUpdateFullNameContestDialog(props) {
  ...
  const handleUpload = () => {
    ...
    request(
      "post",
      "/contests/students/upload-list-for-update-fullname",
      (res) => {
  ...
  return (
    <HustModal
      open={isOpen}
      title={"Upload for Update User FullName of the Contest"}
      onOk={handleUpload}
      textOk="Upload"
      textClose="Cancel"
      onClose={onClose}
