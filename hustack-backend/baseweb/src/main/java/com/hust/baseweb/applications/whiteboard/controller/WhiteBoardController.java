...
public class WhiteBoardController {
    ...
    public void createWhiteboard(
        ...
        whiteboardService.createWhiteboard(
            u.getUserLoginId(),
            input.getWhiteboardId(),
            input.getWhiteboardName(),
            input.getClassSessionId());
    }
    ...
    public ResponseEntity<AddUserToWhiteboardResultModel> addUserToWhiteboard(
        ...
        AddUserToWhiteboardResultModel addUserToWhiteboardResultModel = whiteboardService.addUserToWhiteboard(
            whiteboardId,
            userLogin,
            input);
    ...
    public ResponseEntity<ChangeRoleStatusModel> changeRoleStatusUserWhiteboard(
        ...
        ChangeRoleStatusModel changeRoleStatusModel = whiteboardService.changeRoleStatusUserWhiteboard(
            whiteboardId,
            input);
    ...
    public ResponseEntity<ListDrawRequestPendingModel> getListDrawRequestPending(
        ...
        UserLogin userLogin = userService.findById(principal.getName());
        ListDrawRequestPendingModel listDrawRequestPendingModel = whiteboardService.getListDrawRequestPending(
            whiteboardId,
            userLogin);
